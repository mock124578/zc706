...
module qpsk_hls_top_sin_or_cos_float_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [31:0] p_Result_35;
input  [31:0] p_Result_33;
output  [31:0] c_0_027_out;
output   c_0_027_out_ap_vld;
output  [31:0] c_1_026_out;
output   c_1_026_out_ap_vld;

reg ap_idle;
reg c_0_027_out_ap_vld;
reg c_1_026_out_ap_vld;
...
always @ (*) begin
    if (((icmp_ln311_fu_86_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        c_0_027_out_ap_vld = 1'b1;
    end else begin
        c_0_027_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln311_fu_86_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        c_1_026_out_ap_vld = 1'b1;
    end else begin
        c_1_026_out_ap_vld = 1'b0;
    end
end
...
assign c_0_027_out = c_1_3_fu_48;
...
assign p_Val2_s_fu_108_p3 = ((trunc_ln553_fu_104_p1[0:0] == 1'b1) ? p_Result_35 : p_Result_33);

assign trunc_ln553_fu_104_p1 = ap_sig_allocacmp_i_2[0:0];

endmodule //qpsk_hls_top_sin_or_cos_float_Pipeline_1
