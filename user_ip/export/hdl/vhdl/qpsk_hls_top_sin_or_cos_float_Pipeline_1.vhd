...
entity qpsk_hls_top_sin_or_cos_float_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of qpsk_hls_top_sin_or_cos_float_Pipeline_1 is 
...
begin
    ...
    c_0_027_out <= c_1_3_fu_48;

    c_0_027_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, icmp_ln311_fu_86_p2, ap_start_int)
    begin
        if (((icmp_ln311_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
            c_0_027_out_ap_vld <= ap_const_logic_1;
        else 
            c_0_027_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    c_1_026_out <= c_1_fu_44;

    c_1_026_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, icmp_ln311_fu_86_p2, ap_start_int)
    begin
        if (((icmp_ln311_fu_86_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
            c_1_026_out_ap_vld <= ap_const_logic_1;
        else 
            c_1_026_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    p_Val2_s_fu_108_p3 <= 
        p_Result_35 when (trunc_ln553_fu_104_p1(0) = '1') else 
        p_Result_33;
