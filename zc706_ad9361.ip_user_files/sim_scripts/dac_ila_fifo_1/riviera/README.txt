...
#
# Generated by export_simulation on Fri Oct 17 09:56:14 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './dac_ila_fifo.sh' script.

./dac_ila_fifo.sh -reset_run
...
./dac_ila_fifo.sh -noclean_files

For more information on the script, please type './dac_ila_fifo.sh -help'.
