...
entity system_util_wfifo_0_0_ad_mem is
  port (
    ...
    m_ram_reg_0 : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of system_util_wfifo_0_0_ad_mem is
  ...
  attribute RTL_RAM_BITS of m_ram_reg : label is 16384;
...
m_ram_reg: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      ADDRBWRADDR(13 downto 6) => m_ram_reg_0(7 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_util_wfifo_0_0_util_wfifo is
  port (
  ...
  attribute ADDRESS_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 8;
  attribute DATA_WIDTH : integer;
  attribute DATA_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 64;
  attribute DIN_ADDRESS_WIDTH : integer;
  attribute DIN_ADDRESS_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 8;
  attribute DIN_DATA_WIDTH : integer;
  attribute DIN_DATA_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 16;
  attribute DOUT_DATA_WIDTH : integer;
  attribute DOUT_DATA_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 16;
  ...
  attribute T_DOUT_DATA_WIDTH of system_util_wfifo_0_0_util_wfifo : entity is 128;
end system_util_wfifo_0_0_util_wfifo;

architecture STRUCTURE of system_util_wfifo_0_0_util_wfifo is
  signal \<const0>\ : STD_LOGIC;
  signal data : STD_LOGIC_VECTOR ( 7 downto 3 );
  ...
  signal din_rinit : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal \din_waddr[7]_i_2_n_0\ : STD_LOGIC;
  signal din_waddr_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \dout_raddr[4]_i_2_n_0\ : STD_LOGIC;
  signal \dout_raddr[5]_i_2_n_0\ : STD_LOGIC;
  signal \dout_raddr[7]_i_2_n_0\ : STD_LOGIC;
  signal dout_raddr_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal \p_0_in__2\ : STD_LOGIC_VECTOR ( 7 downto 3 );
  signal p_1_in : STD_LOGIC;
  attribute ASYNC_REG : boolean;
  attribute ASYNC_REG of din_ovf_m1_reg : label is std.standard.true;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \din_waddr[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \din_waddr[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \din_waddr[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \din_waddr[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \din_waddr[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \din_waddr[7]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \dout_raddr[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \dout_raddr[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dout_raddr[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dout_raddr[4]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dout_raddr[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dout_raddr[5]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dout_raddr[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \dout_req_cnt[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \dout_req_cnt[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dout_req_cnt[3]_i_2\ : label is "soft_lutpair1";
...
\din_rinit_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_rinit_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_rinit_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_rinit_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_waddr[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\din_waddr[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\din_waddr[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \din_waddr[7]_i_2_n_0\,
      I1 => din_waddr_reg(6),
      O => \p_0_in__0\(6)
    );
\din_waddr[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\din_waddr[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\din_waddr_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_waddr_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_waddr_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\din_waddr_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_raddr[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I0 => data(4),
      I1 => dout_req_t,
      I2 => \dout_raddr[4]_i_2_n_0\,
      I3 => dout_raddr_reg(4),
      O => \p_0_in__2\(4)
    );
\dout_raddr[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => dout_raddr_reg(0),
      I3 => dout_raddr_reg(2),
      O => \dout_raddr[4]_i_2_n_0\
    );
\dout_raddr[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8BB8"
    )
        port map (
      I0 => data(5),
      I1 => dout_req_t,
      I2 => \dout_raddr[5]_i_2_n_0\,
      I3 => dout_raddr_reg(5),
      O => \p_0_in__2\(5)
    );
\dout_raddr[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I3 => dout_raddr_reg(1),
      I4 => dout_raddr_reg(3),
      O => \dout_raddr[5]_i_2_n_0\
    );
\dout_raddr[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8BB8"
    )
        port map (
      I0 => data(6),
      I1 => dout_req_t,
      I2 => \dout_raddr[7]_i_2_n_0\,
      I3 => dout_raddr_reg(6),
      O => \p_0_in__2\(6)
    );
\dout_raddr[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8BBBB888"
    )
        port map (
...
\dout_raddr[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\dout_raddr_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_raddr_reg[5]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_raddr_reg[6]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_raddr_reg[7]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_rinit_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_rinit_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_rinit_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\dout_rinit_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
i_mem: entity work.system_util_wfifo_0_0_ad_mem
     port map (
      ...
      E(0) => din_wr,
      Q(7 downto 0) => dout_raddr_reg(7 downto 0),
      din_clk => din_clk,
      din_wdata(63 downto 0) => din_wdata(63 downto 0),
      dout_clk => dout_clk,
      m_ram_reg_0(7 downto 0) => din_waddr_reg(7 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_util_wfifo_0_0 is
  port (
    din_rst : in STD_LOGIC;
    din_clk : in STD_LOGIC;
    din_enable_0 : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of system_util_wfifo_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_util_wfifo_0_0 : entity is "system_util_wfifo_0_0,util_wfifo,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_util_wfifo_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_util_wfifo_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_util_wfifo_0_0 : entity is "util_wfifo,Vivado 2021.2";
end system_util_wfifo_0_0;

architecture STRUCTURE of system_util_wfifo_0_0 is
  ...
  attribute ADDRESS_WIDTH : integer;
  attribute ADDRESS_WIDTH of inst : label is 8;
  attribute DATA_WIDTH : integer;
  attribute DATA_WIDTH of inst : label is 64;
  attribute DIN_ADDRESS_WIDTH : integer;
  attribute DIN_ADDRESS_WIDTH of inst : label is 8;
  attribute DIN_DATA_WIDTH : integer;
  ...
  attribute X_INTERFACE_PARAMETER of din_clk : signal is "XIL_INTERFACENAME din_clk, ASSOCIATED_RESET din_rst, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_axi_ad9361_0_0_l_clk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of dout_clk : signal is "XIL_INTERFACENAME dout_clk, ASSOCIATED_RESET dout_rstn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_util_clkdiv_0_0_clk_out, INSERT_VIP 0";
...
begin
inst: entity work.system_util_wfifo_0_0_util_wfifo
     port map (
      din_clk => din_clk,
